...
class BootstrapWalker extends Walker_Nav_Menu
{
    ...
    public function start_lvl(&$output, $depth = 0, $args = null)
    {
        ...
        $classes = array('dropdown-menu sub-menu py-16 py-lg-32');
        /**
    ...
    public function start_el(&$output, $item, $depth = 0, $args = null, $id = 0)
    {
        ...
        if ($this->has_children && 0 === $depth) {
            ...
            $atts['class'] = 'dropdown-toggle nav-link text-blue-500 ps-lg-0';
            $atts['id'] = $args->container_class == "mobile-menu" ? 'menu-item-dropdown-' . $item->ID . '-mobile' : 'menu-item-dropdown-' . $item->ID;
        } else {
        ...
        if ($tag) {
            $item_output .= Blade::render('<x-tag class="ms-8" :size="$size" :type="$type" :title="$title"/>', [
                'title' => $tag,
                'type' => 'success',
                'size' => 'small'
            ]);
